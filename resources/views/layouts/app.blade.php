            ...
            <nav class="flex-1 overflow-y-auto py-6 px-4">
                ...
                <div class="space-y-1 mb-8">
                    ...
                    <a href="{{ route('projects.manage') }}" class="nav-item flex items-center justify-between px-4 py-3.5 text-gray-700 rounded-xl {{ request()->routeIs('projects.*') ? 'active' : '' }}">
                        ...
                        <span class="badge bg-indigo-100 text-indigo-600 text-xs px-2.5 py-1 rounded-full font-medium">
                    ...
                    <a href="{{ route('activities.manage') }}" class="nav-item flex items-center justify-between px-4 py-3.5 text-gray-700 rounded-xl {{ request()->routeIs('activities.*') ? 'active' : '' }}">
                        <div class="flex items-center space-x-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('users.manage') }}"
                        class="nav-item flex items-center space-x-3 px-4 py-3.5 text-gray-700 rounded-xl {{ request()->routeIs('users.*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                        </svg>
                        <span class="text-sm">Gestão de Usuários</span>
                    </a>
                    @endif
                    @endif
